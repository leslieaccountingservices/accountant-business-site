...
export default function BlogLink({ entry }: { entry: EntrySummary}) {
  ...
  return (
    <Link className="w-2/3 md:w-80 h-96 rounded-md border border-black shadow-lg bg-bone overflow-hidden transition ease-in-out delay-50 md:hover:scale-110 md:hover:border-navy duration-300"
